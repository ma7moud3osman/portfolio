    ...
    return InkWell(
      ...
      child: Container(
        padding: Responsive.isMobile(context)
            ? const EdgeInsets.symmetric(horizontal: defaultPadding / 4, vertical: defaultPadding / 1.5).copyWith(bottom: 0)
          ...
          children: [
            ...
            Center(
              child: Hero(
                tag: project.icon!,
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(Responsive.isDesktop(context) ? defaultPadding * 4 : defaultPadding * 1.2),
                  child: CachedNetworkImage(
                    imageUrl: project.icon!,
                    width: 0.23 * min(maxWidth, MediaQuery.of(context).size.width),
                    height: 0.23 * min(maxWidth, MediaQuery.of(context).size.width),
                  ),
                ),
              ),
            ),
